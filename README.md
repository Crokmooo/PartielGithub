...
Bienvenue sur Party Planner, une application web pour ajouter et visualiser des fêtes festives. Les utilisateurs peuvent consulter les prochaines fêtes à venir et gérer leurs propres fêtes.

### Caractéristiques

- Affichage des fêtes à venir
- Création et gestion des fêtes personnelles
...
- `my-events.php` : Liste des fêtes créées par l'utilisateur.
- `event-list.php` : Liste de toutes les fêtes.
- `event-details.php` : Détails d'une fête spécifique.
- `creation-event.php` : Formulaire d'ajout de fête.
